...
public class CalendarView extends VBox {
	...
	public CalendarView(final Locale locale, final Calendar calendar) {
		...
		final MainStackPane mainStackPane = new MainStackPane(this);
		...
		todayButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(final ActionEvent actionEvent) {
				final Calendar calendar = calendarProperty().get();
	...
	private final ObservableList<Integer> disabledWeekdays = FXCollections
			.observableArrayList();
	...
	private final ObservableList<Date> disabledDates = FXCollections
			.observableArrayList();
